...
function globals()
{
	...
	global.playerSkills = array_create(0, 0);
	...
	//Obstacle course quest.
	global.storyTim1 = false; //If tim has been talked to yet.
	global.storyTim2 = false; //If the flag has been collected.


	//Vincent's coffee quest
	global.storyVincent1 = false; //The player has talked to Dr. Jim
	global.storyVincent2 = false; //The player has talked to Vincent after talking to Dr. Jim
	global.storyVincent3 = false; //The player has acquired Vincent's coffee
	global.storyVincent4 = false; //The player has given vincent his coffee and completed his quest.

	
	//Cat return quest
	global.storyCatsStart = false; //The player has talked to the hockey player
	global.storyCatsComplete = false; //The player has returned the cats and completed the quest.
	...
	global.storyKeysCollected = false; //Did the player collect the keys
